...
const About = () => {
  return(
    <>
    <div className="p-4  w-full flex items-center flex-col gap-y-8 md:flex-row  md:justify-start md:gap-x-8">
        <img src="images/AnujyotiDe.jpg" className="w-64 h-64 rounded-full" />
      <div className="w-full flex text-xs justify-start">
        <p className="text-white font-extrabold">Hi, I’m Anujyoti De, a passionate B.Tech student specializing in Information Technology. Currently, I am honing my skills in the field of Frontend Development and Backend Development, with a keen interest in creating dynamic and user-friendly web applications.
