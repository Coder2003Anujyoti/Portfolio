...
const Skills = () => {
  return (
    ...
    <div className="p-8 flex  flex-col gap-8 md:flex-col md:items-center md:text-xl md:p-8">
<div className="flex gap-2 flex-row text-white font-extrabold text-md">
  <img src="images/html-5.png" className="w-8 h-8" />
   <div className="w-96 flex bg-black rounded-full text-white md:text-lg"><div className="w-48 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full md:w-80 "></div></div>80%
</div>
<div className="flex gap-2 flex-row text-white font-extrabold text-md">
...
<div className="flex gap-2 flex-row text-white font-extrabold text-md">
  <img src="images/Tailwind CSS.png" className="w-8 h-8" />
   <div className="w-96 flex bg-black rounded-full text-white"><div className="w-36 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full md:w-60"></div></div>60%
</div>
<div className="flex gap-2 flex-row text-white font-extrabold text-md">
